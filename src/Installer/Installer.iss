...
#define MyAppPublisher "Open Source Developer - Shourjjo Majumder (Shourgamer2)"
#define MyAppURL "https://projects.shourgamer2.tk/software/termbolt"
#define MyAppExeName "termbolt.exe"
#define MyAppAssocName MyAppName + "-Executable-Command-File"
#define MyAppAssocExt ".tbecf"
#define MyAppAssocKey StringChange(MyAppAssocName, " ", "") + MyAppAssocExt

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{A483D6A2-73A1-443D-9F97-53FF5E682FEC}
AppName={#MyAppName}
...
OutputBaseFilename=TermBolt-Setup
SetupIconFile=C:\Users\hp\Downloads\TermBolt.ico
Compression=lzma
